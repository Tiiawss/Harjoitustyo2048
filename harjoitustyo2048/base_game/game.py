...
class Game2048:
    ...
    def __init__(self):
        ...
        Returns: The 4x4 game matrix, start score and the beginning situation 
            on board wicth is two tiles
        """
    ...
    def turn_matrix(self):
        """Turn the board until all direction changes are the same as 
            sliding the pieces to the left.
    ...
    def make_move(self, direction):
        ...
        Returns: the game board in the same position it was before and pieces pushed 
            to the direction they were supposed to go
        """
        if direction == "left":
            self.push_tiles()
